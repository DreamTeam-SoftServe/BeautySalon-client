  ...
  return (
    <section style={{ padding: "120px 5%", background: THEME.colors.white }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }}>
        <div>
          <SectionTitle subtitle={t.contacts.sectionEyebrow} title={t.contacts.sectionTitle} />
          ...
          <div style={{ marginTop: "48px" }}>
            <p style={{ fontFamily: THEME.fonts.sans, fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", color: THEME.colors.gold, marginBottom: "16px" }}>{t.contacts.social}</p>
