...
export const en: Translations = {
  ...
  booking: {
    ...
    pageSubtitle: "Book your appointment or training course in a few simple steps",
    modes: {
      procedure: "Book a Procedure",
    ...
    fields: {
      ...
      phonePh: "+380...",
      service: "Service",
      selectPh: "Select from the list",
      master: "Master",
      masterPh: "Select a master",
      date: "Date",
      datePh: "Select date",
      time: "Time",
      selectDateFirst: "Select date first",
      notes: "Notes",
      notesPh: "Any special preferences?",
    },
    actions: {
      back: "Back",
      next: "Next",
  ...
  store: {
    title: "Our Store",
    eyebrow: "Professional Care Products",
    body: "",
    ...
    inStock: "In Stock",
    outOfProductCategory: "No products available in this category yet",
    categories: {
      all: "All Products",
      shampoo: "Shampoo",
      conditioner: "Conditioner",
      stylingOil: "Styling Oil",
      hairMask: "Hair Mask",
      hairOil: "Hair Oil",
    ...
    checkoutPage: {
      ...
      pickup: "Pickup in Studio (Free)",
      novaPoshta: "Nova Poshta Delivery",
      courier: "Courier Delivery",
      confirmOrder: "Confirm Order",
      orderSummary: "Order Summary",
      total: "Total",
      successMessage: "Order placed successfully! We will contact you soon.",
