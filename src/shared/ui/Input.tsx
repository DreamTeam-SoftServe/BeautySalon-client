...
export function Input({ label, name, type = "text", value, onChange, error, placeholder, as: As = "input", rows }: InputProps) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
      ...
      <Tag
        ...
        rows={rows}
        style={inputStyle}
        onFocus={(e: FocusEvent<HTMLInputElement | HTMLTextAreaElement>) => (e.currentTarget.style.borderColor = THEME.colors.gold)}
        onBlur={(e: FocusEvent<HTMLInputElement | HTMLTextAreaElement>) => (e.currentTarget.style.borderColor = error ? "#C0392B" : "#D4C5A0")}
      />
